...
# Monte-Carlo-Integration (5,5 points)
...
# Procedure
Try to solve this tutorial and answer all questions, you are not allowed to use any additional R packages (this means packages that you have to install additionally to those already installed by default). You can work in groups of up to 5 students. Hand in your solution (as a Rmd file) via [e-mail](mailto:kiessner@stat-econ.uni-kiel.de) until 24.01.2021. Make sure to include all names and stu-numbers in your mail!